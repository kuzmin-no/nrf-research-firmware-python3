...
class nrf24:
  ...
  # Reset USB device
  def reset_radio(self, index):
    device = list(usb.core.find(idVendor=0x1915, idProduct=0x0102, find_all=True))[index]
